...
# Example: 
# ./generate_big_files.sh lena2048color.tiff lena_massive_rotate_2.j2k 81920 2048 40 => output file is bigger than 2^32
# ./generate_big_files.sh lena512color.tiff lena_massive_rotate.j2k 35840 512 70 =>  => output file is bigger than 2^31
...
# export PATH=$PATH:"/home/mickael/dev/src/OpenJPEG/kakadu_bin/"
